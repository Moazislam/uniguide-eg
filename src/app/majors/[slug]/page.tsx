...
import { getMajorBySlug } from "@/lib/majors"; // Assume you'll create this helper
import { 
  BookOpen, 
  Briefcase, 
  GraduationCap, 
...
export default async function MajorDetailPage({ params }: { params: { slug: string } }) {
  // This is where you will fetch your data from the database later
  // const major = await getMajorBySlug(params.slug);
  
  // Placeholder for demonstration
  const majorName = params.slug.replace("-", " ");
    ...
    <div className="min-h-screen flex flex-col bg-[#faf7f2]">
      ...
      <main className="flex-1 w-full max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <header className="mb-12 border-b border-gray-200 pb-8">
          ...
          <h1 className="text-4xl font-black text-[#1a3a5c] font-cairo mb-2 capitalize">
            {majorName}
          </h1>
        ...
        <div className="grid grid-cols-1 gap-12">
          ...
          <section id="definition" className="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm">
            ...
            <div className="prose prose-slate max-w-none text-gray-600 font-cairo leading-relaxed">
              <p>
                ...
                هذا القسم سيحتوي على شرح مفصل عن التخصص وأهدافه الدراسية.
                This section will contain a detailed description of the major and its educational goals.
              </p>
            </div>
          </section>
          ...
          <section id="jobs" className="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm">
            ...
            <ul className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {/* This will be mapped from your database */}
              <li className="flex items-center gap-2 p-4 bg-[#faf7f2] rounded-xl text-gray-700 font-cairo border border-gray-50">
                • مسمى وظيفي مستقبلي / Future Job Title
              </li>
              <li className="flex items-center gap-2 p-4 bg-[#faf7f2] rounded-xl text-gray-700 font-cairo border border-gray-50">
                • مسمى وظيفي مستقبلي / Future Job Title
              </li>
          ...
          {/* 3. Universities in Egypt Section */}
