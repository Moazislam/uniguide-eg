        ...
        <section className="relative overflow-hidden">
          ...
          <div className="relative mx-auto grid max-w-7xl gap-10 px-4 py-16 sm:px-6 lg:px-8 lg:grid-cols-[1.05fr,0.95fr] lg:py-24">
            <div className={`flex flex-col justify-center ${isRtl ? 'text-right' : 'text-left'}`}>
              <div className="inline-flex w-fit items-center gap-2 rounded-full border border-amber/20 bg-amber/5 px-4 py-2 text-xs font-bold uppercase tracking-widest text-amber backdrop-blur border-border">
                <span className="h-2 w-2 rounded-full bg-amber animate-pulse" />
                {t("hero.badge")}
              </div>

              <h1 className="mt-6 text-4xl font-black leading-tight text-text-primary font-cairo sm:text-5xl lg:text-7xl">
                {t("hero.title")}
                <span className="block text-amber font-playfair italic mt-2">{t("hero.titleHighlight")}</span>
              </h1>

              <p className="mt-6 max-w-2xl text-lg leading-relaxed text-text-secondary font-cairo sm:text-xl">
                {t("hero.description")}
              </p>
              ...
              <div className="mt-10 flex flex-col gap-4 sm:flex-row">
                <Link
                  href="/onboarding"
                  className="inline-flex items-center justify-center gap-2 rounded-xl bg-amber px-8 py-4 text-lg font-black text-blue-dark transition-all hover:bg-amber-light hover:scale-[1.02] shadow-[0_10px_20px_rgba(212,168,67,0.2)] active:scale-95"
                >
                  {t("hero.ctaMatch")}
                ...
                <Link
                  href="/universities"
                  className="inline-flex items-center justify-center rounded-xl border-2 border-border bg-card-bg/20 px-8 py-4 text-lg font-bold text-text-primary transition-all hover:border-amber hover:bg-card-bg/40 backdrop-blur-sm active:scale-95"
                >
                  {t("hero.ctaBrowse")}
                </Link>
              </div>
