  ...
  return (
    ...
    >
      <div className="h-32 bg-blue relative overflow-hidden">
        ...
        <div className={`absolute bottom-0 ${isRtl ? 'right-6' : 'left-6'} w-16 h-16 rounded-2xl bg-card-bg shadow-xl border border-border flex items-center justify-center overflow-hidden z-10 group-hover:scale-105 transition-transform duration-300`}>
          {university.logo_url ? (
            <img 
