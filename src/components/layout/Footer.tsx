          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-2 mb-3">
              <div className="w-8 h-8 rounded-lg bg-[#d4a843] flex items-center justify-center">
                <span className="text-[#1a3a5c] font-bold text-sm font-cairo">U</span>
              </div>
            ...
            <div className="flex gap-3 mt-4">
              <a href="https://instagram.com/uni.guidee" target="_blank" rel="noopener noreferrer"
                className="w-8 h-8 rounded-lg bg-white/10 flex items-center justify-center hover:bg-[#d4a843]/20 transition-colors">
                <Instagram size={14} />
              </a>
